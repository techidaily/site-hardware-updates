...
##  What is a Port Out Scam?
 ...
 This is a big problem because many online accounts, including bank accounts, use your phone number as a [two-factor authentication](https://extra-approaches.techidaily.com/updated-premiere-visionary-film-glimpses/) method. They won't let you sign in without sending a code to your phone first. But, after the porting scam has taken place, the criminal will receive that security code on their phone. They could use it to gain access to your financial accounts and other sensitive services.
...
* **AT&T**: Ensure you've set a "[wireless passcode](https://www.anrdoezrs.net/links/3607085/type/dlg/sid/UUhtgUeUpU215211/https://www.att.com/support/)," or PIN, online. This is different from the standard password you use to sign into your online account and must be four-to-eight digits. You may also want to enable "[extra security](https://www.anrdoezrs.net/links/3607085/type/dlg/sid/UUhtgUeUpU215211/https://www.att.com/support/)" online, which will make your wireless passcode required in more situations.
* **T-Mobile**: Call T-Mobile customer service and ask to add "[Port Validation](https://www.t-mobile.com/news/unauthorized-porting-protecting-your-account)" to your account. This is a new six-to-fifteen-digit password that must be provided when you're porting your number. We don't know why, but T-Mobile doesn't let you do this online and forces you to call in.
* **Verizon**: Set a four-digit [account PIN](https://www.anrdoezrs.net/links/3607085/type/dlg/sid/UUhtgUeUpU215211/https://www.verizon.com/support/account-pin-faqs/). If you haven't already set one or don't remember it, you can change it online, in the My Verizon app, or by calling customer service. You should also ensure your My Verizon online account has a secure password, as that password could be used when porting your phone number.
