...
date: 2024-08-28 21:42:28
updated: 2024-08-29 10:56:14
tags:
  - hardware
categories:
  - tech
thumbnail: https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/05/gaming-monitor-with-an-image-that-says-1000hz-as-the-wallpaper.jpg
---
...
##  Superior Motion Clarity at Any Frame Rate
 ...
 The first thing I thought of when I first saw the [announcement of TCL's monitor](https://x.com/BlurBusters/status/1790773962563273119) wasn't frame rates, but motion clarity.

 Flat panel technology has struggled with [smearing and blurring](https://digital-screen-recording.techidaily.com/new-in-2024-the-finest-lineup-top-7-aim-focused-titles/) since day one. This was one of the biggest downgrades when we moved from [CRTs](https://screen-sharing-recording.techidaily.com/updated-2024-approved-mastering-video-recording-and-editing-with-adobe-connect/) to LCD technology, and even the latest top-end OLED panels still don't compare favorably with the best CRTs. There are several reasons why this smearing appears, but one of the main culprits happens because of the "sample and hold" nature of these displays.
...
![Person using a gaming mouse under pink neon lights next to an RGB keyboard.](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2023/11/person-using-a-gaming-mouse-under-pink-neon-lights-next-to-an-rgb-keyboard.jpg) 

[aslysun/Shutterstock.com](https://www.shutterstock.com/image-photo/close-pro-cyber-sport-gamer-play-1799229778)

 There are various types of latency that affect what you see on your screen, and more importantly, _when_ you see it. For example, there's a time delay between something changing internally in a computer program and the result being shown on your screen. For example, an enemy player or character moving into view and shooting at you, happens a fraction of a second before you actually see it on screen. This is because it takes time for the data leaving your graphics card to become an image on your display.
 ...
 This can go wrong as well, as in the case of "[frame tearing](https://tech-haven.techidaily.com/unpacking-the-preloaded-features-of-chatgpt-functions-and-implementation-tips/)" where the image data is updated partway through a refresh, and you'll see part of one frame and the next fused into one. This presents as a "tear" across the screen. [Vsync](https://facebook-video-content.techidaily.com/how-to-enhance-facebook-stream-volume-completely-for-2024/) fixes this by delaying each frame until the next refresh is ready at the cost of latency. screens, capable of [variable refresh rates](https://iphone-location.techidaily.com/how-to-change-your-location-on-apple-iphone-13-pro-drfone-by-drfone-virtual-ios/), dynamically change when the next refresh happens, so it offers better responsiveness than Vsync. Besides that, variable refresh rate technology comes with its [own set of issues](https://remote-screen-capture.techidaily.com/new-streamlining-remote-recordings-a-producers-guide-for-2024/).
